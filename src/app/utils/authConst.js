...
export const IDENTITY_CONFIG = {
    ...
    audience: "https://auth.pinpointguam.com", //is there a way to specific the audience when making the jwt
    response_type: "token id_token", //(string, default: 'id_token'): The type of response desired from the OIDC provider.
    grantType: "password",
    scope: "openid profile email roles api1", //(string, default: 'openid'): The scope being requested from the OIDC provider.
    webAuthResponseType: "id_token token"
};

export const METADATA_OIDC = {
    issuer: "https://auth.pinpointguam.com",
